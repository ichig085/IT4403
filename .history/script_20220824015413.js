...
x.onclick = function () {
    ...
    rightContainer.setAttribute("style", "top: 22rem; right: 8.75rem; width: 26vw; transform: rotate(0deg);");
    navContainer.setAttribute("style", "position: relative; top: 10rem; margin-left: 50rem; margin-top: 3rem; width:  transform: rotate(0deg);");
