...
x.onclick = function () {
    ...
    //margin-top is 3rem and margin-left is 
    navContainer.setAttribute("style", "position: relative; top: 10rem; margin-left: 50rem; margin-top: -8.5rem; width: auto; transform: rotate(0deg);");
