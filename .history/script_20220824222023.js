...
x.onclick = function () {
    ...
    navContainer.setAttribute("style", "position: relative; top: 10rem; margin-left: 55rem; margin-top: -8.5rem; width: 35%; transform: rotate(0deg);");
    //margin is 50px for leftContainer
    leftContainer.setAttribute("style", "margin-top: -1rem; left: 100px; transform: rotate(0deg);");
    rightContainer.setAttribute("style", "top: 12rem; right: 9.75rem; width: 30vw; transform: rotate(0deg);");
